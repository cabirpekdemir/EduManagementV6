...
<div class="container-fluid">
    ...
    <h3 class="card-title">
        ...
        <!-- YENİ EKLENEN KISIM -->
        <?php if ($userRole === 'admin' && isset($stats['pending_announcements']) && $stats['pending_announcements'] > 0): ?>
            <a href="index.php?module=announcements&action=index" class="ml-2">
                <span class="badge badge-warning">
                    <?= htmlspecialchars($stats['pending_announcements']) ?> Onay Bekliyor
                </span>
            </a>
        <?php endif; ?>
    </h3>
