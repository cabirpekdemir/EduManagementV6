<?php
// modules/students/view/edit.php - TAM KAPSAMLI VERSİYON
$student = $student ?? [];
$classes = $classes ?? [];
$teachers = $teachers ?? [];

// Hata sonrası form verilerini koru
...
<section class="content">
    <div class="container-fluid">
        ...
        <form method="POST" action="index.php?module=students&action=update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="tc_kimlik" 
                                           value="<?= htmlspecialchars($student['tc_kimlik'] ?? '') ?>"
                                           maxlength="11"
                                           pattern="[0-9]{11}"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" name="gender" required>
                                        ...
                                        <option value="Kız" <?= ($student['gender'] ?? '') == 'Kız' ? 'selected' : '' ?>>Kız</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="tel" 
                                           class="form-control phone-mask" 
                                           name="phone2" 
                                           value="<?= htmlspecialchars($student['phone2'] ?? '') ?>"
                                           placeholder="(5__) ___ __ __"
                                           maxlength="15">
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="tel" 
                                           class="form-control phone-mask" 
                                           name="phone3" 
                                           value="<?= htmlspecialchars($student['phone3'] ?? '') ?>"
                                           placeholder="(5__) ___ __ __"
                                           maxlength="15">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="okul" 
                                           value="<?= htmlspecialchars($student['okul'] ?? '') ?>"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($student['graduated_school'] ?? '') ?>"
                                           placeholder="Önceki okul adı">
                                </div>
                                
                                <!-- Sınıf (seviye) -->
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Sınıf (Seviye)</label>
                                    <input type="text" 
                                           class="form-control" 
                                           name="sinif" 
                                           value="<?= htmlspecialchars($student['sinif'] ?? '') ?>"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" name="teaching_type">
                                        <option value="">Seçiniz...</option>
                                        <option value="tam_gun" <?= ($student['teaching_type'] ?? '') == 'tam_gun' ? 'selected' : '' ?>>🕐 Tam Gün</option>
                                        <option value="sabahci" <?= ($student['teaching_type'] ?? '') == 'sabahci' ? 'selected' : '' ?>>🌅 Sabahçı</option>
                                        <option value="oglenci" <?= ($student['teaching_type'] ?? '') == 'oglenci' ? 'selected' : '' ?>>🌆 Öğlenci</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="time" 
                                           ...
                                           value="<?= htmlspecialchars($student['school_entry_time'] ?? '') ?>">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="time" 
                                           ...
                                           value="<?= htmlspecialchars($student['school_exit_time'] ?? '') ?>">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           value="<?= htmlspecialchars($student['entrance_exam_score'] ?? '') ?>"
                                           step="0.01"
                                           min="0"
                                           max="100"
                                           placeholder="0.00">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="preference_id" 
                                           value="<?= htmlspecialchars($student['preference_id'] ?? '') ?>">
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="choice_number" 
                                           value="<?= htmlspecialchars($student['choice_number'] ?? '') ?>"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" 
                                               ...
                                               id="special_talent" 
                                               value="1"
                                               <?= !empty($student['special_talent']) ? 'checked' : '' ?>>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="enrollment_status">
                                        <option value="on_kayit" <?= ($student['enrollment_status'] ?? 'on_kayit') == 'on_kayit' ? 'selected' : '' ?>>📝 Ön Kayıt</option>
                                        <option value="sinav_secim" <?= ($student['enrollment_status'] ?? '') == 'sinav_secim' ? 'selected' : '' ?>>📋 Sınav Seçim</option>
                                        <option value="sinav_secimi_yapti" <?= ($student['enrollment_status'] ?? '') == 'sinav_secimi_yapti' ? 'selected' : '' ?>>✅ Sınav Seçimi Yaptı</option>
                                        <option value="ders_secimi_yapan" <?= ($student['enrollment_status'] ?? '') == 'ders_secimi_yapan' ? 'selected' : '' ?>>📚 Ders Seçimi Yapan</option>
                                        <option value="sinav_sonuc_girisi" <?= ($student['enrollment_status'] ?? '') == 'sinav_sonuc_girisi' ? 'selected' : '' ?>>📊 Sınav Sonuç Girişi</option>
                                        <option value="sinavi_kazanamayan" <?= ($student['enrollment_status'] ?? '') == 'sinavi_kazanamayan' ? 'selected' : '' ?>>❌ Sınavı Kazanamayan</option>
                                        <option value="aktif" <?= ($student['enrollment_status'] ?? '') == 'aktif' ? 'selected' : '' ?>>✅ Aktif Öğrenci</option>
                                        <option value="kayit_dondurma" <?= ($student['enrollment_status'] ?? '') == 'kayit_dondurma' ? 'selected' : '' ?>>⏸️ Kayıt Dondurma</option>
                                        <option value="kayit_silinen" <?= ($student['enrollment_status'] ?? '') == 'kayit_silinen' ? 'selected' : '' ?>>🗑️ Kayıt Silinen</option>
                                        <option value="mezun" <?= ($student['enrollment_status'] ?? '') == 'mezun' ? 'selected' : '' ?>>🎓 Mezun</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" 
                                               ...
                                               id="is_active" 
                                               value="1"
                                               <?= !empty($student['is_active']) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" 
                                               ...
                                               id="approved" 
                                               value="1"
                                               <?= !empty($student['approved']) ? 'checked' : '' ?>>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-select" name="blood_type">
                                        ...
                                        ?>
                                            <option value="<?= $bt ?>" <?= ($student['blood_type'] ?? '') == $bt ? 'selected' : '' ?>>
                                                <?= $bt ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($student['chronic_condition'] ?? '') ?>"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="allergy" 
                                           value="<?= htmlspecialchars($student['allergy'] ?? '') ?>"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" 
                                           class="form-control" 
                                           name="medications" 
                                           value="<?= htmlspecialchars($student['medications'] ?? '') ?>"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= htmlspecialchars($student['health_disabilities'] ?? '') ?>"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              name="health_notes" 
                                              rows="4"
                                              placeholder="Öğretmenlerin bilmesi gereken özel sağlık durumları..."><?= htmlspecialchars($student['health_notes'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              name="hobbies" 
                                              rows="3"
                                              placeholder="Örn: Futbol, Resim, Müzik, Robotik..."><?= htmlspecialchars($student['hobbies'] ?? '') ?></textarea>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              name="student_note" 
                                              rows="4"
                                              placeholder="Öğrenci hakkında genel notlar..."><?= htmlspecialchars($student['student_note'] ?? '') ?></textarea>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              name="teacher_note" 
                                              rows="4"
                                              placeholder="Öğretmen notları..."><?= htmlspecialchars($student['teacher_note'] ?? '') ?></textarea>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              name="note" 
                                              rows="3"
                                              placeholder="Diğer notlar ve açıklamalar..."><?= htmlspecialchars($student['note'] ?? '') ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="photo" role="tabpanel">
                    <div class="card shadow-sm">
                        <div class="card-header bg-dark text-white">
                            <h5 class="mb-0"><i class="fa fa-camera"></i> Profil Fotoğrafı Güncelle</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <?php if (!empty($student['profile_photo'])): ?>
                                <div class="alert alert-info">
                                    <strong>Mevcut Fotoğraf:</strong> Yeni fotoğraf yüklemezseniz mevcut fotoğraf korunur.
                                </div>
                            <?php endif; ?>
            ...
            <div class="card shadow-sm mt-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="index.php?module=students&action=view&id=<?= $student['id'] ?>" class="btn btn-secondary">
